...
export function getMockData(): ReportData {
  return {
    id: "mock-report-123",
    ...
    results: [
      ...
      },
      {
        ...
        suggestions: [
          ...
          "Incorporate at least 30 mins of moderate cardio 5 times a week.",
      ...
      },
      {
        ...
        suggestions: [
          "Spend 15-20 minutes in the morning sun daily.",
          "Eat more fatty fish like salmon or fortified foods.",
          "Consider discussing a vitamin D supplement with your doctor if diet isn't enough."
        ]
      }
    ]
  };
